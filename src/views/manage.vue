<template>
  <div class="list">
    ...
    <div class="contain">
      <div>
        <span class="plan">空域管理</span><span class="current_plan">{{currentPlanName}}</span>
      </div>
      <br/><br/>
      <ul class="current_banner">
        <li><a @click="switcher(1)" class="banner_color" :class="{active:isActive == 1}">空域调度&nbsp;&nbsp;&nbsp;&nbsp;<i class="icon iconfont icon-you"></i></a></li>
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
        <li><a @click="switcher(2)" class="banner_color" :class="{active:isActive == 2}">班机航线&nbsp;&nbsp;&nbsp;&nbsp;<i class="icon iconfont icon-you"></i></a></li>
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
        <li><a @click="switcher(3)" class="banner_color" :class="{active:isActive == 3}">相关规定&nbsp;&nbsp;&nbsp;&nbsp;<i class="icon iconfont icon-you"></i></a></li>
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
        <li><a @click="switcher(4)" class="banner_color" :class="{active:isActive == 4}">新技术应用&nbsp;&nbsp;&nbsp;&nbsp;<i class="icon iconfont icon-you"></i></a></li>
      </ul>
    </div>
    <div class="contain">
